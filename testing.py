...
print()
print(f"Decryption accuracy Bob Addition: {round(accuracy_a,2)}%")
print(f"Decryption accuracy Bob Multiplication: {round(accuracy,2)}%")
print(f"Decryption accuracy P1: {round(accuracy_p1,2)}%")
print(f"Decryption accuracy P2: {round(accuracy_p2,2)}%")
